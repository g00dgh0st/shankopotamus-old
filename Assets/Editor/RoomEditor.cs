...
public class RoomEditor : Editor
{
    ...
    {  
        ...
        ShowOnEnum("cameraType","HorizontalScroll","YLock"); 
        ShowOnEnum("cameraType","VerticalScroll","XLock"); 
        
        ShowOnEnum("characterScaleType","Static","characterScale"); 
        
        ShowOnEnum("characterScaleType","Depth","backY"); 
